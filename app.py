...
# Load trained model
model = load_model('./dl_model/model.h5')

# Load label encoder
with open('./preprocessors/gender_label_encoder.pkl', 'rb') as file:
    gender_encoder = pickle.load(file)

# Load onehot encoder
with open('./preprocessors/onehot_geo_encoder.pkl', 'rb') as file:
    geo_encoder = pickle.load(file)

# Load standard scaler
with open('./preprocessors/standard_scaler.pkl', 'rb') as file:
